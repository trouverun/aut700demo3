...
#include "control_interfaces/srv/detail/set_position__rosidl_typesupport_fastrtps_c.h"
...
using _SetPosition_Request__ros_msg_type = control_interfaces__srv__SetPosition_Request;
...
size_t get_serialized_size_control_interfaces__srv__SetPosition_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPosition_Request__ros_msg_type * ros_message = static_cast<const _SetPosition_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetPosition_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_control_interfaces__srv__SetPosition_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control_interfaces
size_t max_serialized_size_control_interfaces__srv__SetPosition_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control_interfaces__srv__SetPosition_Request;
    is_plain =
      (
...
static size_t _SetPosition_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_control_interfaces__srv__SetPosition_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, control_interfaces, srv, SetPosition_Request)() {
...
using _SetPosition_Response__ros_msg_type = control_interfaces__srv__SetPosition_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control_interfaces
size_t get_serialized_size_control_interfaces__srv__SetPosition_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPosition_Response__ros_msg_type * ros_message = static_cast<const _SetPosition_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_control_interfaces__srv__SetPosition_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control_interfaces
size_t max_serialized_size_control_interfaces__srv__SetPosition_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = control_interfaces__srv__SetPosition_Response;
    is_plain =
      (
...
static size_t _SetPosition_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_control_interfaces__srv__SetPosition_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, control_interfaces, srv, SetPosition_Response)() {
...
// already included above
// #include "control_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "control_interfaces/srv/set_position.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, control_interfaces, srv, SetPosition)() {
