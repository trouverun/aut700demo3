...
#include "control_interfaces/srv/detail/set_goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const control_interfaces::srv::SetGoal_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  control_interfaces::srv::SetGoal_Request & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control_interfaces::srv::SetGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const control_interfaces::srv::SetGoal_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<control_interfaces::srv::SetGoal_Request *>(
    untyped_ros_message);
...
{
  return &control_interfaces::srv::typesupport_fastrtps_cpp::_SetGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_interfaces, srv, SetGoal_Request)() {
  return &control_interfaces::srv::typesupport_fastrtps_cpp::_SetGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_control_interfaces
cdr_serialize(
  const control_interfaces::srv::SetGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  control_interfaces::srv::SetGoal_Response & ros_message)
{
  // Member: success
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = control_interfaces::srv::SetGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const control_interfaces::srv::SetGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<control_interfaces::srv::SetGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &control_interfaces::srv::typesupport_fastrtps_cpp::_SetGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_interfaces, srv, SetGoal_Response)() {
  return &control_interfaces::srv::typesupport_fastrtps_cpp::_SetGoal_Response__handle;
}
...
{
  return &control_interfaces::srv::typesupport_fastrtps_cpp::_SetGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_interfaces, srv, SetGoal)() {
  return &control_interfaces::srv::typesupport_fastrtps_cpp::_SetGoal__handle;
}
