...
class Metaclass_SetPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'control_interfaces.srv.SetPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from control_interfaces.srv import _set_pose
...
class SetPose(metaclass=Metaclass_SetPose):
    from control_interfaces.srv._set_pose import SetPose_Request as Request
    from control_interfaces.srv._set_pose import SetPose_Response as Response
